...
import { Calendar, ThumbsUp, Share2, Filter } from "lucide-react";
      ...
      <div className="container mx-auto px-4">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-6">
          {filteredPosts.map((post) => (
            <Link key={post.id} to={`/${post.category === "여행지" ? "destinations" : post.category === "여행 가이드" ? "guides" : post.category === "여행 이야기" ? "stories" : "benefits"}/1`}>
